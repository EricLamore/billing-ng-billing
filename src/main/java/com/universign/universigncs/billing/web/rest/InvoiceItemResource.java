...
public class InvoiceItemResource {
    ...
    public ResponseEntity<InvoiceItem> updateInvoiceItem(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, invoiceItem.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<InvoiceItem> partialUpdateInvoiceItem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, invoiceItem.getId())
        );
    }
